 ...
 * </pre>
 */
public final class SlcResourceUtils {
    ...
    public static int getIdByName(String name) {
        return SlcUtils.getApp().getResources().getIdentifier(name, "id", SlcUtils.getApp().getPackageName());
    }
    ...
    public static int getStringIdByName(String name) {
        return SlcUtils.getApp().getResources().getIdentifier(name, "string", SlcUtils.getApp().getPackageName());
    }
    ...
    public static int getColorIdByName(String name) {
        return SlcUtils.getApp().getResources().getIdentifier(name, "color", SlcUtils.getApp().getPackageName());
    }
    ...
    public static int getDimenIdByName(String name) {
        return SlcUtils.getApp().getResources().getIdentifier(name, "dimen", SlcUtils.getApp().getPackageName());
    }
    ...
    public static int getDrawableIdByName(String name) {
        return SlcUtils.getApp().getResources().getIdentifier(name, "drawable", SlcUtils.getApp().getPackageName());
    }
    ...
    public static int getMipmapIdByName(String name) {
        return SlcUtils.getApp().getResources().getIdentifier(name, "mipmap", SlcUtils.getApp().getPackageName());
    }
    ...
    public static int getLayoutIdByName(String name) {
        return SlcUtils.getApp().getResources().getIdentifier(name, "layout", SlcUtils.getApp().getPackageName());
    }
    ...
    public static int getStyleIdByName(String name) {
        return SlcUtils.getApp().getResources().getIdentifier(name, "style", SlcUtils.getApp().getPackageName());
    }
    ...
    public static int getAnimIdByName(String name) {
        return SlcUtils.getApp().getResources().getIdentifier(name, "anim", SlcUtils.getApp().getPackageName());
    }
    ...
    public static int getMenuIdByName(String name) {
        return SlcUtils.getApp().getResources().getIdentifier(name, "menu", SlcUtils.getApp().getPackageName());
    }
    ...
    public static boolean copyFileFromAssets(final String assetsFilePath, final String destFilePath) {
        boolean res = true;
        try {
            String[] assets = SlcUtils.getApp().getAssets().list(assetsFilePath);
            if (assets.length > 0) {
                ...
                res = writeFileFromIS(
                        destFilePath,
                        SlcUtils.getApp().getAssets().open(assetsFilePath),
                        false
                );
            }
        } catch (IOException e) {
    ...
    public static String readAssets2String(final String assetsFilePath, final String charsetName) {
        InputStream is;
        try {
            is = SlcUtils.getApp().getAssets().open(assetsFilePath);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static List<String> readAssets2List(final String assetsPath,
        ...
        try {
            return is2List(SlcUtils.getApp().getResources().getAssets().open(assetsPath), charsetName);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static boolean copyFileFromRaw(@RawRes final int resId, final String destFilePath) {
        return writeFileFromIS(
                destFilePath,
                SlcUtils.getApp().getResources().openRawResource(resId),
                false
        );
    }
    ...
    public static String readRaw2String(@RawRes final int resId, final String charsetName) {
        InputStream is = SlcUtils.getApp().getResources().openRawResource(resId);
        byte[] bytes = is2Bytes(is);
        if (bytes == null) return null;
        if (isSpace(charsetName)) {
            return new String(bytes);
    ...
    public static List<String> readRaw2List(@RawRes final int resId,
                                            final String charsetName) {
        return is2List(SlcUtils.getApp().getResources().openRawResource(resId), charsetName);
    }
