 ...
 *     time  : 2016/8/1
 *     desc  : SlcUtils about device
 * </pre>
 */
public final class SlcDeviceUtils {

        private SlcDeviceUtils() {
        ...
        public static boolean isAdbEnabled() {
            return Settings.Secure.getInt(
                    SlcUtils.getApp().getContentResolver(),
        ...
        private static String getMacAddressByWifiInfo() {
            try {
                final WifiManager wifi = (WifiManager) SlcUtils.getApp()
        ...
        private static String getMacAddressByFile() {
            SlcShellUtils.CommandResult result = SlcShellUtils.execCmd("getprop wifi.interface", false);
            if (result.result == 0) {
                String name = result.successMsg;
                if (name != null) {
                    result = SlcShellUtils.execCmd("cat /sys/class/net/" + name + "/address", false);
                    if (result.result == 0) {
        ...
        public static boolean isTablet() {
            return (SlcUtils.getApp().getResources().getConfiguration().screenLayout
        ...
        public static boolean isEmulator() {
            ...
            String operatorName = "";
            TelephonyManager tm = (TelephonyManager) SlcUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE);
            if (tm != null) {
            ...
            boolean checkDial = intent.resolveActivity(SlcUtils.getApp().getPackageManager()) == null;
...
//        if (checkDebuggerConnected) return true;
        ...
        public static String getUniqueDeviceId(String prefix) {
            if (udid == null) {
                synchronized (SlcDeviceUtils.class) {
                    if (udid == null) {
                        final String id = SlcUtils.getSlcSPUtils4Utils().getString(KEY_UDID, null);
                        if (id != null) {
                            udid = id;
                            return udid;
                        }
        ...
        public static boolean isSameDevice(final String uniqueDeviceId) {
            ...
            final String cachedId = SlcUtils.getSlcSPUtils4Utils().getString(KEY_UDID, null);
        ...
        private static String saveUdid(String prefix, String id) {
            ...
            SlcSPUtils.getInstance().put(KEY_UDID, udid);
            return udid;
        }
