 ...
 * </pre>
 */
public final class SlcCleanUtils {

    private SlcCleanUtils() {
    ...
    public static boolean cleanInternalCache() {
        return deleteFilesInDir(SlcUtils.getApp().getCacheDir());
    }
    ...
    public static boolean cleanInternalFiles() {
        return deleteFilesInDir(SlcUtils.getApp().getFilesDir());
    }
    ...
    public static boolean cleanInternalDbs() {
        return deleteFilesInDir(new File(SlcUtils.getApp().getFilesDir().getParent(), "databases"));
    }
    ...
    public static boolean cleanInternalDbByName(final String dbName) {
        return SlcUtils.getApp().deleteDatabase(dbName);
    }
    ...
    public static boolean cleanInternalSp() {
        return deleteFilesInDir(new File(SlcUtils.getApp().getFilesDir().getParent(), "shared_prefs"));
    }
    ...
    public static boolean cleanExternalCache() {
        return Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())
                && deleteFilesInDir(SlcUtils.getApp().getExternalCacheDir());
    }
