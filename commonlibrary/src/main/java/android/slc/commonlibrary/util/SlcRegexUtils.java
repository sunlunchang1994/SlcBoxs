...
import android.slc.commonlibrary.constant.SlcRegexConstants;
...
public final class SlcRegexUtils {
    ...
    public static boolean isMobileSimple(final CharSequence input) {
        return isMatch(SlcRegexConstants.REGEX_MOBILE_SIMPLE, input);
    }
    ...
    public static boolean isMobileExact(final CharSequence input) {
        return isMatch(SlcRegexConstants.REGEX_MOBILE_EXACT, input);
    }
    ...
    public static boolean isTel(final CharSequence input) {
        return isMatch(SlcRegexConstants.REGEX_TEL, input);
    }
    ...
    public static boolean isIDCard15(final CharSequence input) {
        return isMatch(SlcRegexConstants.REGEX_ID_CARD15, input);
    }
    ...
    public static boolean isIDCard18(final CharSequence input) {
        return isMatch(SlcRegexConstants.REGEX_ID_CARD18, input);
    }
    ...
    public static boolean isEmail(final CharSequence input) {
        return isMatch(SlcRegexConstants.REGEX_EMAIL, input);
    }
    ...
    public static boolean isURL(final CharSequence input) {
        return isMatch(SlcRegexConstants.REGEX_URL, input);
    }
    ...
    public static boolean isZh(final CharSequence input) {
        return isMatch(SlcRegexConstants.REGEX_ZH, input);
    }
    ...
    public static boolean isUsername(final CharSequence input) {
        return isMatch(SlcRegexConstants.REGEX_USERNAME, input);
    }

    /**
     * Return whether input matches regex of data which pattern is "yyyy-MM-dd".
     *
     * @param input The input.
     * @return {@code true}: yes<br>{@code false}: no
     */
    public static boolean isDate(final CharSequence input) {
        return isMatch(SlcRegexConstants.REGEX_DATE, input);
    }
    ...
    public static boolean isIP(final CharSequence input) {
        return isMatch(SlcRegexConstants.REGEX_IP, input);
    }
