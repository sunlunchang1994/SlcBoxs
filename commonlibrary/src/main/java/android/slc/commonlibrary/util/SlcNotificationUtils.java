 ...
 *     time  : 2019/02/20
 *     desc  : SlcUtils about notification
 * </pre>
 */
public class SlcNotificationUtils {
    ...
    public static boolean areNotificationsEnabled() {
        return NotificationManagerCompat.from(SlcUtils.getApp()).areNotificationsEnabled();
    }
     ...
     */
    public static void notify(int id, SlcUtils.Func1<Void, NotificationCompat.Builder> func1) {
     ...
     * @param func1 The function of create the builder of notification.
     */
    public static void notify(String tag, int id, SlcUtils.Func1<Void, NotificationCompat.Builder> func1) {
     ...
     * @param func1         The function of create the builder of notification.
     */
    public static void notify(int id, ChannelConfig channelConfig, SlcUtils.Func1<Void, NotificationCompat.Builder> func1) {
     ...
     * @param func1         The function of create the builder of notification.
     */
    public static void notify(String tag, int id, ChannelConfig channelConfig, SlcUtils.Func1<Void, NotificationCompat.Builder> func1) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            NotificationManager nm = (NotificationManager) SlcUtils.getApp().getSystemService(Context.NOTIFICATION_SERVICE);
            nm.createNotificationChannel(channelConfig.getNotificationChannel());
        }

        NotificationManagerCompat nmc = NotificationManagerCompat.from(SlcUtils.getApp());

        NotificationCompat.Builder builder = new NotificationCompat.Builder(SlcUtils.getApp());
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
    ...
    public static void cancel(String tag, final int id) {
        NotificationManagerCompat.from(SlcUtils.getApp()).cancel(tag, id);
    }
    ...
    public static void cancel(final int id) {
        NotificationManagerCompat.from(SlcUtils.getApp()).cancel(id);
    }
    ...
    public static void cancelAll() {
        NotificationManagerCompat.from(SlcUtils.getApp()).cancelAll();
    }
    ...
    public static class ChannelConfig {
        ...
        public static final ChannelConfig DEFAULT_CHANNEL_CONFIG = new ChannelConfig(
                SlcUtils.getApp().getPackageName(), SlcUtils.getApp().getPackageName(), IMPORTANCE_DEFAULT
        );
