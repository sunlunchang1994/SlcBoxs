 ...
 * </pre>
 */
public final class SlcNetworkUtils {

    private SlcNetworkUtils() {
    ...
    public static SlcUtils.Task<Boolean> isAvailableAsync(@NonNull final SlcUtils.Callback<Boolean> callback) {
        return SlcUtils.doAsync(new SlcUtils.Task<Boolean>(callback) {
            @RequiresPermission(INTERNET)
            @Override
     ...
     */
    @RequiresPermission(INTERNET)
    public static void isAvailableByPingAsync(final SlcUtils.Callback<Boolean> callback) {
     ...
     */
    @RequiresPermission(INTERNET)
    public static SlcUtils.Task<Boolean> isAvailableByPingAsync(final String ip,
                                                             @NonNull final SlcUtils.Callback<Boolean> callback) {
        return SlcUtils.doAsync(new SlcUtils.Task<Boolean>(callback) {
            @RequiresPermission(INTERNET)
            @Override
            public Boolean doInBackground() {
    ...
    public static boolean isAvailableByPing(final String ip) {
        ...
        SlcShellUtils.CommandResult result = SlcShellUtils.execCmd(String.format("ping -c 1 %s", realIp), false);
     ...
     */
    @RequiresPermission(INTERNET)
    public static void isAvailableByDnsAsync(final SlcUtils.Callback<Boolean> callback) {
     ...
     */
    @RequiresPermission(INTERNET)
    public static SlcUtils.Task isAvailableByDnsAsync(final String domain,
                                                   @NonNull final SlcUtils.Callback<Boolean> callback) {
        return SlcUtils.doAsync(new SlcUtils.Task<Boolean>(callback) {
            @RequiresPermission(INTERNET)
            @Override
    ...
    public static boolean getMobileDataEnabled() {
        try {
            ...
            Log.e("SlcNetworkUtils", "getMobileDataEnabled: ", e);
        }
        return false;
    }
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) SlcUtils.getApp().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) SlcUtils.getApp().getSystemService(Context.CONNECTIVITY_SERVICE);
     ...
     */
    @RequiresPermission(allOf = {ACCESS_WIFI_STATE, INTERNET})
    public static SlcUtils.Task<Boolean> isWifiAvailableAsync(@NonNull final SlcUtils.Callback<Boolean> callback) {
        return SlcUtils.doAsync(new SlcUtils.Task<Boolean>(callback) {
            @RequiresPermission(allOf = {ACCESS_WIFI_STATE, INTERNET})
            @Override
            public Boolean doInBackground() {
     ...
     * @return type of network
     * <ul>
     * <li>{@link SlcNetworkUtils.NetworkType#NETWORK_ETHERNET} </li>
     * <li>{@link SlcNetworkUtils.NetworkType#NETWORK_WIFI    } </li>
     * <li>{@link SlcNetworkUtils.NetworkType#NETWORK_4G      } </li>
     * <li>{@link SlcNetworkUtils.NetworkType#NETWORK_3G      } </li>
     * <li>{@link SlcNetworkUtils.NetworkType#NETWORK_2G      } </li>
     * <li>{@link SlcNetworkUtils.NetworkType#NETWORK_UNKNOWN } </li>
     * <li>{@link SlcNetworkUtils.NetworkType#NETWORK_NO      } </li>
     * </ul>
     */
    @RequiresPermission(ACCESS_NETWORK_STATE)
     ...
     * @return the task
     */
    public static SlcUtils.Task<String> getIPAddressAsync(final boolean useIPv4,
                                                       @NonNull final SlcUtils.Callback<String> callback) {
        return SlcUtils.doAsync(new SlcUtils.Task<String>(callback) {
            @RequiresPermission(INTERNET)
            @Override
     ...
     */
    @RequiresPermission(INTERNET)
    public static SlcUtils.Task<String> getDomainAddressAsync(final String domain,
                                                           @NonNull final SlcUtils.Callback<String> callback) {
        return SlcUtils.doAsync(new SlcUtils.Task<String>(callback) {
            @RequiresPermission(INTERNET)
            @Override
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) SlcUtils.getApp().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
    ...
    public static final class NetworkChangedReceiver extends BroadcastReceiver {
        ...
        void registerListener(final OnNetworkStatusChangedListener listener) {
            ...
            SlcUtils.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (preSize == 0 && mListeners.size() == 1) {
                        ...
                        SlcUtils.getApp().registerReceiver(NetworkChangedReceiver.getInstance(), intentFilter);
                    }
                }
            });
        }
            ...
            SlcUtils.runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    if (preSize == 1 && mListeners.size() == 0) {
                        SlcUtils.getApp().unregisterReceiver(NetworkChangedReceiver.getInstance());
                    }
                }
            });
        }
        ...
        public void onReceive(Context context, Intent intent) {
            if (ConnectivityManager.CONNECTIVITY_ACTION.equals(intent.getAction())) {
                // debouncing
                SlcUtils.runOnUiThreadDelayed(new Runnable() {
                    @Override
                    public void run() {
                        NetworkType networkType = SlcNetworkUtils.getNetworkType();
                        if (mType == networkType) return;
                        SlcLogUtils.e(networkType);
                        mType = networkType;
