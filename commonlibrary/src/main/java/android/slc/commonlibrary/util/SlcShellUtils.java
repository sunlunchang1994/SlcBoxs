 ...
 * </pre>
 */
public final class SlcShellUtils {

    private static final String LINE_SEP = System.getProperty("line.separator");

    private SlcShellUtils() {
     ...
     * @return the task
     */
    public static SlcUtils.Task<CommandResult> execCmdAsync(final String command,
                                                         final boolean isRooted,
                                                         final SlcUtils.Callback<CommandResult> callback) {
     ...
     * @return the task
     */
    public static SlcUtils.Task<CommandResult> execCmdAsync(final List<String> commands,
                                                         final boolean isRooted,
                                                         final SlcUtils.Callback<CommandResult> callback) {
     ...
     * @return the task
     */
    public static SlcUtils.Task<CommandResult> execCmdAsync(final String[] commands,
                                                         final boolean isRooted,
                                                         final SlcUtils.Callback<CommandResult> callback) {
    ...
    public static SlcUtils.Task<CommandResult> execCmdAsync(final String[] commands,
                                                         final boolean isRooted,
                                                         final boolean isNeedResultMsg,
                                                         @NonNull final SlcUtils.Callback<CommandResult> callback) {
        return SlcUtils.doAsync(new SlcUtils.Task<CommandResult>(callback) {
            @Override
