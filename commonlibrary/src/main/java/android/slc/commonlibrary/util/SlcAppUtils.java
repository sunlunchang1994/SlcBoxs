 ...
 * </pre>
 */
public final class SlcAppUtils {
     ...
     */
    public static void registerAppStatusChangedListener(@NonNull final SlcUtils.OnAppStatusChangedListener listener) {
        SlcUtils.getActivityLifecycle().addOnAppStatusChangedListener(listener);
    }
     ...
     * @param listener The status of application changed listener
     */
    public static void unregisterAppStatusChangedListener(@NonNull final SlcUtils.OnAppStatusChangedListener listener) {
        SlcUtils.getActivityLifecycle().removeOnAppStatusChangedListener(listener);
    }
    ...
    public static void installApp(final File file) {
        ...
        SlcUtils.getApp().startActivity(getInstallAppIntent(file, true));
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        SlcUtils.getApp().startActivity(getUninstallAppIntent(packageName, true));
    }
    ...
    public static boolean isAppInstalled(@NonNull final String pkgName) {
        PackageManager packageManager = SlcUtils.getApp().getPackageManager();
        try {
    ...
    public static boolean isAppRoot() {
        SlcShellUtils.CommandResult result = SlcShellUtils.execCmd("echo root", true);
    ...
    public static boolean isAppDebug() {
        return isAppDebug(SlcUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppSystem() {
        return isAppSystem(SlcUtils.getApp().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        return SlcUtils.isAppForeground();
    }
    ...
    public static boolean isAppRunning(@NonNull final String pkgName) {
        ...
        ActivityManager am = (ActivityManager) SlcUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        if (am != null) {
    ...
    public static void launchApp(final String packageName) {
        ...
        SlcUtils.getApp().startActivity(launchAppIntent);
    }
    ...
    public static void relaunchApp(final boolean isKillProcess) {
        Intent intent = getLaunchAppIntent(SlcUtils.getApp().getPackageName(), true);
        if (intent == null) {
            Log.e("AppUtils", "Didn't exist launcher activity.");
            return;
        }
    ...
    public static void launchAppDetailsSettings() {
        launchAppDetailsSettings(SlcUtils.getApp().getPackageName());
    }
    ...
    public static void exitApp() {
        List<Activity> activityList = SlcUtils.getActivityList();
    ...
    public static Drawable getAppIcon() {
        return getAppIcon(SlcUtils.getApp().getPackageName());
    }
    ...
    public static int getAppIconId() {
        return getAppIconId(SlcUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPackageName() {
        return SlcUtils.getApp().getPackageName();
    }
    ...
    public static String getAppName() {
        return getAppName(SlcUtils.getApp().getPackageName());
    }
    ...
    public static String getAppPath() {
        return getAppPath(SlcUtils.getApp().getPackageName());
    }
    ...
    public static String getAppVersionName() {
        return getAppVersionName(SlcUtils.getApp().getPackageName());
    }
    ...
    public static int getAppVersionCode() {
        return getAppVersionCode(SlcUtils.getApp().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(SlcUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(SlcUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureSHA256() {
        return getAppSignatureSHA256(SlcUtils.getApp().getPackageName());
    }
    ...
    public static String getAppSignatureMD5() {
        return getAppSignatureMD5(SlcUtils.getApp().getPackageName());
    }
    ...
    public static int getAppUid() {
        return getAppUid(SlcUtils.getApp().getPackageName());
    }
    ...
    public static int getAppUid(String pkgName) {
        try {
            ApplicationInfo ai = SlcUtils.getApp().getPackageManager().getApplicationInfo(pkgName, 0);
            if (ai != null) {
                return ai.uid;
            }
        } catch (Exception e) {
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(SlcUtils.getApp().getPackageName());
    }
     ...
     * @return the application's package information
     */
    public static SlcAppUtils.AppInfo getApkInfo(final File apkFile) {
     ...
     * @return the application's package information
     */
    public static SlcAppUtils.AppInfo getApkInfo(final String apkFilePath) {
    ...
    private static Intent getInstallAppIntent(final File file, final boolean isNewTask) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            String authority = SlcUtils.getApp().getPackageName() + ".provider";
            data = FileProvider.getUriForFile(SlcUtils.getApp(), authority, file);
            intent.setFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
        }
        SlcUtils.getApp().grantUriPermission(SlcUtils.getApp().getPackageName(), data, Intent.FLAG_GRANT_READ_URI_PERMISSION);
    ...
    private static String getForegroundProcessName() {
        ActivityManager am =
                (ActivityManager) SlcUtils.getApp().getSystemService(Context.ACTIVITY_SERVICE);
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// Access to usage information.
                ApplicationInfo info =
                        pm.getApplicationInfo(SlcUtils.getApp().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) SlcUtils.getApp().getSystemService(Context.APP_OPS_SERVICE);
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) SlcUtils.getApp()
