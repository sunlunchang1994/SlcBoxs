 ...
 *     time  : 2016/09/29
 *     desc  : SlcUtils about toast
 * </pre>
 */
public final class SlcToastUtils {
    ...
    private static void show(final int resId, final int duration, final Object... args) {
        try {
            CharSequence text = SlcUtils.getApp().getResources().getText(resId);
            if (args != null) {
    ...
    private static void show(final CharSequence text, final int duration) {
        SlcUtils.runOnUiThread(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.makeToast(SlcUtils.getApp(), text, duration);
    ...
    private static void show(final View view, final int duration) {
        SlcUtils.runOnUiThread(new Runnable() {
            ...
            public void run() {
                cancel();
                iToast = ToastFactory.newToast(SlcUtils.getApp());
                iToast.setView(view);
    ...
    private static View getView(@LayoutRes final int layoutId) {
        LayoutInflater inflate =
                (LayoutInflater) SlcUtils.getApp().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    ...
    static class ToastWithoutNotification extends AbsToast {
        ...
        private static final SlcUtils.OnActivityDestroyedListener LISTENER =
                new SlcUtils.OnActivityDestroyedListener() {
                    @Override
        ...
        private void realShow() {
            ...
            if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N_MR1) {
                ...
                Context topActivityOrApp = SlcUtils.getTopActivityOrApp();
                ...
                SlcUtils.getActivityLifecycle().addOnActivityDestroyedListener(topActivity, LISTENER);
            }
            ...
            mParams.packageName = SlcUtils.getApp().getPackageName();
