 ...
 * </pre>
 */
public class SlcMessengerUtils {
    ...
    public static void register() {
        if (isMainProcess()) {
            ...
            Intent intent = new Intent(SlcUtils.getApp(), ServerService.class);
            SlcUtils.getApp().startService(intent);
            return;
        }
    ...
    public static void unregister() {
        if (isMainProcess()) {
            ...
            Intent intent = new Intent(SlcUtils.getApp(), ServerService.class);
            SlcUtils.getApp().stopService(intent);
        }
        if (sLocalClient != null) {
            sLocalClient.unbind();
        }
    ...
    private static boolean isMainProcess() {
        return SlcUtils.getApp().getPackageName().equals(SlcUtils.getCurrentProcessName());
    }
    ...
    static class Client {
        ...
        ServiceConnection mConn   = new ServiceConnection() {
            ...
            public void onServiceConnected(ComponentName name, IBinder service) {
                ...
                int key = SlcUtils.getCurrentProcessName().hashCode();
        ...
        boolean bind() {
            if (TextUtils.isEmpty(mPkgName)) {
                Intent intent = new Intent(SlcUtils.getApp(), ServerService.class);
                return SlcUtils.getApp().bindService(intent, mConn, Context.BIND_AUTO_CREATE);
            }
        ...
        void unbind() {
            ...
            try {
                SlcUtils.getApp().unbindService(mConn);
