 ...
 * </pre>
 */
public final class SlcMetaDataUtils {

    private SlcMetaDataUtils() {
    ...
    public static String getMetaDataInApp(@NonNull final String key) {
        ...
        String packageName = SlcUtils.getApp().getPackageName();
        try {
    ...
    public static String getMetaDataInActivity(@NonNull final Class<? extends Activity> clz,
        ...
        String value = "";
        PackageManager pm = SlcUtils.getApp().getPackageManager();
        ComponentName componentName = new ComponentName(SlcUtils.getApp(), clz);
        try {
