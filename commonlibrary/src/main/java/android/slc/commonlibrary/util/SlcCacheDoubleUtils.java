 ...
 * </pre>
 */
public final class SlcCacheDoubleUtils implements SlcCacheConstants {

    private static final Map<String, SlcCacheDoubleUtils> CACHE_MAP = new HashMap<>();

    private final SlcCacheMemoryUtils mSlcCacheMemoryUtils;
    private final SlcCacheDiskUtils   mSlcCacheDiskUtils;

    /**
     * Return the single {@link SlcCacheDoubleUtils} instance.
     *
     * @return the single {@link SlcCacheDoubleUtils} instance
     */
    public static SlcCacheDoubleUtils getInstance() {
        return getInstance(SlcCacheMemoryUtils.getInstance(), SlcCacheDiskUtils.getInstance());
    }
     ...
     * @return the single {@link SlcCacheDoubleUtils} instance
     */
    public static SlcCacheDoubleUtils getInstance(@NonNull final SlcCacheMemoryUtils SlcCacheMemoryUtils,
                                               @NonNull final SlcCacheDiskUtils SlcCacheDiskUtils) {
        final String cacheKey = SlcCacheDiskUtils.toString() + "_" + SlcCacheMemoryUtils.toString();
        SlcCacheDoubleUtils cache = CACHE_MAP.get(cacheKey);
        if (cache == null) {
            synchronized (SlcCacheDoubleUtils.class) {
                cache = CACHE_MAP.get(cacheKey);
                if (cache == null) {
                    cache = new SlcCacheDoubleUtils(SlcCacheMemoryUtils, SlcCacheDiskUtils);
    ...
    private SlcCacheDoubleUtils(SlcCacheMemoryUtils SlcCacheMemoryUtils, SlcCacheDiskUtils cacheUtils) {
        mSlcCacheMemoryUtils = SlcCacheMemoryUtils;
        mSlcCacheDiskUtils = cacheUtils;
    }
    ...
    public void put(@NonNull final String key, byte[] value, final int saveTime) {
        mSlcCacheMemoryUtils.put(key, value, saveTime);
        mSlcCacheDiskUtils.put(key, value, saveTime);
    }
    ...
    public byte[] getBytes(@NonNull final String key, final byte[] defaultValue) {
        byte[] obj = mSlcCacheMemoryUtils.get(key);
        if (obj != null) return obj;
        return mSlcCacheDiskUtils.getBytes(key, defaultValue);
    }
    ...
    public String getString(@NonNull final String key, final String defaultValue) {
        String obj = mSlcCacheMemoryUtils.get(key);
        if (obj != null) return obj;
        return mSlcCacheDiskUtils.getString(key, defaultValue);
    }
    ...
    public JSONObject getJSONObject(@NonNull final String key, final JSONObject defaultValue) {
        JSONObject obj = mSlcCacheMemoryUtils.get(key);
        if (obj != null) return obj;
        return mSlcCacheDiskUtils.getJSONObject(key, defaultValue);
    }
    ...
    public JSONArray getJSONArray(@NonNull final String key, final JSONArray defaultValue) {
        JSONArray obj = mSlcCacheMemoryUtils.get(key);
        if (obj != null) return obj;
        return mSlcCacheDiskUtils.getJSONArray(key, defaultValue);
    }
    ...
    public Bitmap getBitmap(@NonNull final String key, final Bitmap defaultValue) {
        Bitmap obj = mSlcCacheMemoryUtils.get(key);
        if (obj != null) return obj;
        return mSlcCacheDiskUtils.getBitmap(key, defaultValue);
    }
    ...
    public Drawable getDrawable(@NonNull final String key, final Drawable defaultValue) {
        Drawable obj = mSlcCacheMemoryUtils.get(key);
        if (obj != null) return obj;
        return mSlcCacheDiskUtils.getDrawable(key, defaultValue);
    }
    ...
    public <T> T getParcelable(@NonNull final String key,
        ...
        T value = mSlcCacheMemoryUtils.get(key);
        if (value != null) return value;
        return mSlcCacheDiskUtils.getParcelable(key, creator, defaultValue);
    }
    ...
    public Object getSerializable(@NonNull final String key, final Object defaultValue) {
        Object obj = mSlcCacheMemoryUtils.get(key);
        if (obj != null) return obj;
        return mSlcCacheDiskUtils.getSerializable(key, defaultValue);
    }
    ...
    public long getCacheDiskSize() {
        return mSlcCacheDiskUtils.getCacheSize();
    }
    ...
    public int getCacheDiskCount() {
        return mSlcCacheDiskUtils.getCacheCount();
    }
    ...
    public int getCacheMemoryCount() {
        return mSlcCacheMemoryUtils.getCacheCount();
    }
    ...
    public void remove(@NonNull String key) {
        mSlcCacheMemoryUtils.remove(key);
        mSlcCacheDiskUtils.remove(key);
    }
     ...
     */
    public void clear() {
        mSlcCacheMemoryUtils.clear();
        mSlcCacheDiskUtils.clear();
    }
}
