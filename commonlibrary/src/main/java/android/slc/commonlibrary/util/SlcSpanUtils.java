 ...
 * </pre>
 */
public final class SlcSpanUtils {
    ...
    private SlcSpanUtils(TextView textView) {
        this();
        mTextView = textView;
    }
     ...
     *             </ul>
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setForegroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setBackgroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setBullet(@ColorInt final int color,
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setFontProportion(final float proportion) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setFontXProportion(final float proportion) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setStrikethrough() {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setUnderline() {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setSuperscript() {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setSubscript() {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setHorizontalAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setVerticalAlign(@Align final int align) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setUrl(@NonNull final String url) {
        if (mTextView != null && mTextView.getMovementMethod() == null) {
            mTextView.setMovementMethod(LinkMovementMethod.getInstance());
        }
        this.url = url;
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                             final Blur style) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                               final float dx,
                               final float dy,
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils appendLine() {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils appendImage(@NonNull final Uri uri) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils appendImage(@DrawableRes final int resourceId) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils appendImage(@DrawableRes final int resourceId, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link SlcSpanUtils} instance
     */
    public SlcSpanUtils appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
...
//                    "lineHeight: " + (bottom - top));
    ...
    public static SlcSpanUtils with(final TextView textView) {
        return new SlcSpanUtils(textView);
    }
}
