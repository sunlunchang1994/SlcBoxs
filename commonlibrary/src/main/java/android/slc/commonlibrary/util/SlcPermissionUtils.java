...
import android.slc.commonlibrary.constant.SlcPermissionConstants;
 ...
 *     time  : 2017/12/29
 *     desc  : SlcUtils about permission
 * </pre>
 */
public final class SlcPermissionUtils {

    private static final List<String> PERMISSIONS = getPermissions();

    private static SlcPermissionUtils sInstance;
    ...
    public static List<String> getPermissions() {
        return getPermissions(SlcUtils.getApp().getPackageName());
    }
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(SlcUtils.getApp(), permission);
    }
    ...
    public static boolean isGrantedWriteSettings() {
        return Settings.System.canWrite(SlcUtils.getApp());
    }
    ...
    private static void startWriteSettingsActivity(final Activity activity, final int requestCode) {
        ...
        intent.setData(Uri.parse("package:" + SlcUtils.getApp().getPackageName()));
    ...
    public static boolean isGrantedDrawOverlays() {
        return Settings.canDrawOverlays(SlcUtils.getApp());
    }
     ...
     *
     * @param permissions The permissions.
     * @return the single {@link SlcPermissionUtils} instance
     */
    public static SlcPermissionUtils permission(final String... permissions) {
        return new SlcPermissionUtils(permissions);
    }
    ...
    private SlcPermissionUtils(final String... permissions) {
        mPermissions = new LinkedHashSet<>();
        for (String permission : permissions) {
            for (String aPermission : SlcPermissionConstants.getPermissions(permission)) {
     ...
     * @return the single {@link SlcPermissionUtils} instance
     */
    public SlcPermissionUtils rationale(final OnRationaleListener listener) {
     ...
     * @return the single {@link SlcPermissionUtils} instance
     */
    public SlcPermissionUtils callback(final SimpleCallback callback) {
     ...
     * @return the single {@link SlcPermissionUtils} instance
     */
    public SlcPermissionUtils callback(final FullCallback callback) {
     ...
     * @return the single {@link SlcPermissionUtils} instance
     */
    public SlcPermissionUtils theme(final ThemeCallback callback) {
    ...
    @RequiresApi(api = Build.VERSION_CODES.M)
    static final class PermissionActivityImpl extends SlcUtils.TransActivity.TransActivityDelegate {
        ...
        public static void start(final int type) {
            SlcUtils.TransActivity.start(new SlcUtils.Func1<Void, Intent>() {
                @Override
        ...
        public void onCreated(Activity activity, @Nullable Bundle savedInstanceState) {
            ...
            if (type == TYPE_RUNTIME) {
                if (sInstance == null) {
                    Log.e("SlcPermissionUtils", "request permissions failed");
                    activity.finish();
                    return;
                }
                ...
                activity.finish();
                Log.e("SlcPermissionUtils", "type is wrong.");
            }
        }
