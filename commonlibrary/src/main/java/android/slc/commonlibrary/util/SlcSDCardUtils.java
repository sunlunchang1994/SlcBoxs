 ...
 *     time  : 2016/08/11
 *     desc  : SlcUtils about sdcard
 * </pre>
 */
public final class SlcSDCardUtils {

    private SlcSDCardUtils() {
    ...
    public static List<SDCardInfo> getSDCardInfo() {
        ...
        StorageManager sm = (StorageManager) SlcUtils.getApp().getSystemService(Context.STORAGE_SERVICE);
