 ...
 * </pre>
 */
public final class SlcCacheDoubleStaticUtils {

    private static SlcCacheDoubleUtils sDefaultCacheDoubleUtils;

    /**
     * Set the default instance of {@link SlcCacheDoubleUtils}.
     *
     * @param cacheDoubleUtils The default instance of {@link SlcCacheDoubleUtils}.
     */
    public static void setDefaultCacheDoubleUtils(final SlcCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @param key              The key of cache.
     * @param value            The value of cache.
     * @param cacheDoubleUtils The instance of {@link SlcCacheDoubleUtils}.
     */
    public static void put(@NonNull final String key,
                           final byte[] value,
                           @NonNull final SlcCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the bytes if cache exists or null otherwise
     */
    public static byte[] getBytes(@NonNull final String key, @NonNull final SlcCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the string value if cache exists or null otherwise
     */
    public static String getString(@NonNull final String key, @NonNull final SlcCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the JSONArray if cache exists or null otherwise
     */
    public static JSONArray getJSONArray(@NonNull final String key, @NonNull final SlcCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the bitmap if cache exists or null otherwise
     */
    public static Bitmap getBitmap(@NonNull final String key, @NonNull final SlcCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the drawable if cache exists or null otherwise
     */
    public static Drawable getDrawable(@NonNull final String key, @NonNull final SlcCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the bitmap if cache exists or null otherwise
     */
    public static Object getSerializable(@NonNull final String key, @NonNull final SlcCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the size of cache in disk
     */
    public static long getCacheDiskSize(@NonNull final SlcCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the count of cache in disk
     */
    public static int getCacheDiskCount(@NonNull final SlcCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @return the count of cache in memory.
     */
    public static int getCacheMemoryCount(@NonNull final SlcCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @param cacheDoubleUtils The instance of {@link SlcCacheDoubleUtils}.
     */
    public static void remove(@NonNull String key, @NonNull final SlcCacheDoubleUtils cacheDoubleUtils) {
     ...
     * @param cacheDoubleUtils The instance of {@link SlcCacheDoubleUtils}.
     */
    public static void clear(@NonNull final SlcCacheDoubleUtils cacheDoubleUtils) {
        cacheDoubleUtils.clear();
    }

    private static SlcCacheDoubleUtils getDefaultCacheDoubleUtils() {
        return sDefaultCacheDoubleUtils != null ? sDefaultCacheDoubleUtils : SlcCacheDoubleUtils.getInstance();
    }
}
