 ...
 * </pre>
 */
public final class SlcSnackbarUtils {
    ...
    private SlcSnackbarUtils(final View parent) {
        setDefault();
        this.view = parent;
    }
    ...
    /**
     * Set the view to find cpb_complete_state_selector parent from.
     *
     * @param view The view to find cpb_complete_state_selector parent from.
     * @return the single {@link SlcSnackbarUtils} instance
     */
    public static SlcSnackbarUtils with(@NonNull final View view) {
        return new SlcSnackbarUtils(view);
    }
     ...
     * @return the single {@link SlcSnackbarUtils} instance
     */
    public SlcSnackbarUtils setMessage(@NonNull final CharSequence msg) {
        this.message = msg;
        return this;
    }
     ...
     * @return the single {@link SlcSnackbarUtils} instance
     */
    public SlcSnackbarUtils setMessageColor(@ColorInt final int color) {
     ...
     * @return the single {@link SlcSnackbarUtils} instance
     */
    public SlcSnackbarUtils setBgColor(@ColorInt final int color) {
        this.bgColor = color;
        return this;
    }
     ...
     * @return the single {@link SlcSnackbarUtils} instance
     */
    public SlcSnackbarUtils setBgResource(@DrawableRes final int bgResource) {
     ...
     * @return the single {@link SlcSnackbarUtils} instance
     */
    public SlcSnackbarUtils setDuration(@Duration final int duration) {
     ...
     * @return the single {@link SlcSnackbarUtils} instance
     */
    public SlcSnackbarUtils setAction(@NonNull final CharSequence text,
     ...
     */
    public SlcSnackbarUtils setBottomMargin(@IntRange(from = 1) final int bottomMargin) {
