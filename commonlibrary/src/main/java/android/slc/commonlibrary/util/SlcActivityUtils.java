 ...
 * </pre>
 */
public final class SlcActivityUtils {

    private SlcActivityUtils() {
    ...
    public static boolean isActivityExists(@NonNull final String pkg,
        ...
        return !(SlcUtils.getApp().getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(SlcUtils.getApp().getPackageManager()) == null ||
                SlcUtils.getApp().getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void startActivity(@NonNull final Class<? extends Activity> clz) {
        Context context = SlcUtils.getTopActivityOrApp();
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(SlcUtils.getTopActivityOrApp(), null, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final String pkg,
                                     @NonNull final String cls,
                                     @Nullable final Bundle options) {
        startActivity(SlcUtils.getTopActivityOrApp(), null, pkg, cls, options);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     @NonNull final String pkg,
                                     @NonNull final String cls) {
        startActivity(SlcUtils.getTopActivityOrApp(), extras, pkg, cls, null);
    }
    ...
    public static void startActivity(@NonNull final Bundle extras,
                                     ...
                                     @NonNull final String cls,
                                     @Nullable final Bundle options) {
        startActivity(SlcUtils.getTopActivityOrApp(), extras, pkg, cls, options);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent) {
        return startActivity(intent, SlcUtils.getTopActivityOrApp(), null);
    }
    ...
    public static boolean startActivity(@NonNull final Intent intent,
                                        @Nullable final Bundle options) {
        return startActivity(intent, SlcUtils.getTopActivityOrApp(), options);
    }
    ...
    public static void startActivityForResult(@NonNull final Fragment fragment,
                                              @NonNull final Class<? extends Activity> clz,
                                              final int requestCode) {
        startActivityForResult(fragment, null, SlcUtils.getApp().getPackageName(), clz.getName(),
                requestCode, null);
    }
    ...
    public static void startActivityForResult(@NonNull final Bundle extras,
                                              ...
                                              @NonNull final Class<? extends Activity> clz,
                                              final int requestCode) {
        startActivityForResult(fragment, extras, SlcUtils.getApp().getPackageName(), clz.getName(),
                requestCode, null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents) {
        startActivities(intents, SlcUtils.getTopActivityOrApp(), null);
    }
    ...
    public static void startActivities(@NonNull final Intent[] intents,
                                       @Nullable final Bundle options) {
        startActivities(intents, SlcUtils.getTopActivityOrApp(), options);
    }
    ...
    public static void startLauncherActivity() {
        startLauncherActivity(SlcUtils.getApp().getPackageName());
    }
    ...
    public static List<Activity> getActivityList() {
        return SlcUtils.getActivityList();
    }
    ...
    public static String getLauncherActivity() {
        return getLauncherActivity(SlcUtils.getApp().getPackageName());
    }
    ...
    public static List<String> getMainActivities() {
        return getMainActivities(SlcUtils.getApp().getPackageName());
    }
    ...
    public static Activity getTopActivity() {
        return SlcUtils.getActivityLifecycle().getTopActivity();
    }
    ...
    public static boolean isActivityExistsInStack(@NonNull final Activity activity) {
        List<Activity> activities = SlcUtils.getActivityList();
    ...
    public static Drawable getActivityIcon(@NonNull final Class<? extends Activity> clz) {
        return getActivityIcon(new ComponentName(SlcUtils.getApp(), clz));
    }
    ...
    public static Drawable getActivityLogo(@NonNull final Class<? extends Activity> clz) {
        return getActivityLogo(new ComponentName(SlcUtils.getApp(), clz));
    }
