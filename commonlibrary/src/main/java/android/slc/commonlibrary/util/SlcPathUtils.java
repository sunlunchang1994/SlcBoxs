...
public class SlcPathUtils {
    ...
    public static String getInternalAppDataPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            return SlcUtils.getApp().getApplicationInfo().dataDir;
        }
        return getAbsolutePath(SlcUtils.getApp().getDataDir());
    }
    ...
    public static String getInternalAppCodeCacheDir() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return SlcUtils.getApp().getApplicationInfo().dataDir + "/code_cache";
        }
        return getAbsolutePath(SlcUtils.getApp().getCodeCacheDir());
    }
    ...
    public static String getInternalAppCachePath() {
        return getAbsolutePath(SlcUtils.getApp().getCacheDir());
    }
    ...
    public static String getInternalAppDbsPath() {
        return SlcUtils.getApp().getApplicationInfo().dataDir + "/databases";
    }
    ...
    public static String getInternalAppDbPath(String name) {
        return getAbsolutePath(SlcUtils.getApp().getDatabasePath(name));
    }
    ...
    public static String getInternalAppFilesPath() {
        return getAbsolutePath(SlcUtils.getApp().getFilesDir());
    }
    ...
    public static String getInternalAppSpPath() {
        return SlcUtils.getApp().getApplicationInfo().dataDir + "/shared_prefs";
    }
    ...
    public static String getInternalAppNoBackupFilesPath() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
            return SlcUtils.getApp().getApplicationInfo().dataDir + "/no_backup";
        }
        return getAbsolutePath(SlcUtils.getApp().getNoBackupFilesDir());
    }
    ...
    public static String getExternalAppDataPath() {
        if (isExternalStorageDisable()) return "";
        File externalCacheDir = SlcUtils.getApp().getExternalCacheDir();
    ...
    public static String getExternalAppCachePath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(SlcUtils.getApp().getExternalCacheDir());
    }
    ...
    public static String getExternalAppFilesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(SlcUtils.getApp().getExternalFilesDir(null));
    }
    ...
    public static String getExternalAppMusicPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(SlcUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_MUSIC));
    }
    ...
    public static String getExternalAppPodcastsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(SlcUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_PODCASTS));
    }
    ...
    public static String getExternalAppRingtonesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(SlcUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_RINGTONES));
    }
    ...
    public static String getExternalAppAlarmsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(SlcUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_ALARMS));
    }
    ...
    public static String getExternalAppNotificationsPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(SlcUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_NOTIFICATIONS));
    }
    ...
    public static String getExternalAppPicturesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(SlcUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_PICTURES));
    }
    ...
    public static String getExternalAppMoviesPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(SlcUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_MOVIES));
    }
    ...
    public static String getExternalAppDownloadPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(SlcUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS));
    }
    ...
    public static String getExternalAppDcimPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(SlcUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_DCIM));
    }
    ...
    public static String getExternalAppDocumentsPath() {
        if (isExternalStorageDisable()) return "";
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.KITKAT) {
            return getAbsolutePath(SlcUtils.getApp().getExternalFilesDir(null)) + "/Documents";
        }
        return getAbsolutePath(SlcUtils.getApp().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS));
    }
    ...
    public static String getExternalAppObbPath() {
        if (isExternalStorageDisable()) return "";
        return getAbsolutePath(SlcUtils.getApp().getObbDir());
    }
