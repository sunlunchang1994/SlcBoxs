 ...
 * </pre>
 */
public final class SlcUiMessageUtils implements Handler.Callback {

    private static final String  TAG   = "SlcUiMessageUtils";
    ...
    public static SlcUiMessageUtils getInstance() {
        return LazyHolder.INSTANCE;
    }

    private SlcUiMessageUtils() {
    }
    ...
    private static boolean isAppDebug() {
        try {
            ...
            ApplicationInfo ai = pm.getApplicationInfo(SlcUtils.getApp().getPackageName(), 0);
    ...
    private static final class LazyHolder {
        private static final SlcUiMessageUtils INSTANCE = new SlcUiMessageUtils();
    }
}