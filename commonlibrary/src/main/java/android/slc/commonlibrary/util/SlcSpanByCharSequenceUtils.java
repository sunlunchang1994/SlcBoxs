 ...
 * </pre>
 */
public final class SlcSpanByCharSequenceUtils {
    ...
    public SlcSpanByCharSequenceUtils() {
     ...
     *             </ul>
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setFlag(final int flag) {
        this.flag = flag;
        return this;
    }
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setForegroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setBackgroundColor(@ColorInt final int color) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setLineHeight(@IntRange(from = 0) final int lineHeight) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setQuoteColor(@ColorInt final int color) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setLeadingMargin(@IntRange(from = 0) final int first,
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setBullet(@IntRange(from = 0) final int gapWidth) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setBullet(@ColorInt final int color,
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setFontSize(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setFontSize(@IntRange(from = 0) final int size, final boolean isSp) {
        this.fontSize = size;
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setFontProportion(final float proportion) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setFontXProportion(final float proportion) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setStrikethrough() {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setUnderline() {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setSuperscript() {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setSubscript() {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setBold() {
        isBold = true;
        return this;
    }
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setItalic() {
        isItalic = true;
        return this;
    }
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setBoldItalic() {
        isBoldItalic = true;
        return this;
    }
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setFontFamily(@NonNull final String fontFamily) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setTypeface(@NonNull final Typeface typeface) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setHorizontalAlign(@NonNull final Alignment alignment) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setVerticalAlign(@Align final int align) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setClickSpan(@NonNull final ClickableSpan clickSpan) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setUrl(@NonNull final String url) {
        this.url = url;
        return this;
    }
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setBlur(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                              final Blur style) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setShader(@NonNull final Shader shader) {
        this.shader = shader;
        return this;
    }
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setShadow(@FloatRange(from = 0, fromInclusive = false) final float radius,
                                                final float dx,
                                                final float dy,
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils setSpans(@NonNull final Object... spans) {
        if (spans.length > 0) {
            this.spans = spans;
        }
        return this;
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils append(@NonNull final CharSequence text) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils appendLine() {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils appendLine(@NonNull final CharSequence text) {
        apply(mTypeCharSequence);
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils appendImage(@NonNull final Bitmap bitmap) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils appendImage(@NonNull final Bitmap bitmap, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils appendImage(@NonNull final Drawable drawable) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils appendImage(@NonNull final Drawable drawable, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils appendImage(@NonNull final Uri uri) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils appendImage(@NonNull final Uri uri, @Align final int align) {
        apply(mTypeImage);
        this.imageUri = uri;
        this.alignImage = align;
        return this;
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils appendImage(@DrawableRes final int resourceId) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils appendImage(@DrawableRes final int resourceId, @Align final int align) {
        apply(mTypeImage);
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils appendSpace(@IntRange(from = 0) final int size) {
     ...
     * @return the single {@link SlcSpanByCharSequenceUtils} instance
     */
    public SlcSpanByCharSequenceUtils appendSpace(@IntRange(from = 0) final int size, @ColorInt final int color) {
        apply(mTypeSpace);
        spaceSize = size;
        spaceColor = color;
        return this;
...
//            }
    ...
    static class CustomImageSpan extends CustomDynamicDrawableSpan {
        ...
        private CustomImageSpan(final Bitmap b, final int verticalAlignment) {
            ...
            mDrawable = new BitmapDrawable(SlcUtils.getApp().getResources(), b);
            mDrawable.setBounds(
        ...
        public Drawable getDrawable() {
            ...
            if (mDrawable != null) {
                ...
                try {
                    InputStream is =
                            SlcUtils.getApp().getContentResolver().openInputStream(mContentUri);
                    bitmap = BitmapFactory.decodeStream(is);
                    drawable = new BitmapDrawable(SlcUtils.getApp().getResources(), bitmap);
                    drawable.setBounds(
                ...
                try {
                    drawable = ContextCompat.getDrawable(SlcUtils.getApp(), mResourceId);
                    drawable.setBounds(
                            0, 0, drawable.getIntrinsicWidth(), drawable.getIntrinsicHeight()
                    );
                } catch (Exception e) {
...
//            SlcLogUtils.d("rectHeight: " + rect.height(),
//                    "lineHeight: " + (bottom - top));
    ...
    public static SlcSpanByCharSequenceUtils with() {
        return new SlcSpanByCharSequenceUtils();
    }

    public static SpannableStringBuilder getTextByForegroundColor(String source, String accentText,
                                                                  int foregroundColor) {
        if (source == null) {
        ...
        SlcSpanByCharSequenceUtils slcSpanByCharSequenceUtils = SlcSpanByCharSequenceUtils.with();
        String[] dataArray = source.split(accentText);
        for (int i = 0; i < dataArray.length; i++) {
            slcSpanByCharSequenceUtils.append(dataArray[i]);
            if (i != dataArray.length - 1) {
                slcSpanByCharSequenceUtils.append(accentText).setForegroundColor(foregroundColor);
            }
        }
        if (source.endsWith(accentText)) {
            slcSpanByCharSequenceUtils.append(accentText).setForegroundColor(foregroundColor);
        }
        return slcSpanByCharSequenceUtils.create();
    }
}
