 ...
 * </pre>
 */
public final class SlcServiceUtils {

    private SlcServiceUtils() {
    ...
    public static void startService(final Class<?> cls) {
        Intent intent = new Intent(SlcUtils.getApp(), cls);
    ...
    public static boolean stopService(final Class<?> cls) {
        Intent intent = new Intent(SlcUtils.getApp(), cls);
        return SlcUtils.getApp().stopService(intent);
    }
    ...
    public static void bindService(final Class<?> cls,
                                   ...
                                   final int flags) {
        Intent intent = new Intent(SlcUtils.getApp(), cls);
        SlcUtils.getApp().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(final ServiceConnection conn) {
        SlcUtils.getApp().unbindService(conn);
    }
