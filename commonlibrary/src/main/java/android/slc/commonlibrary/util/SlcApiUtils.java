 ...
 * </pre>
 */
public final class SlcApiUtils {

    private static final String TAG = "SlcApiUtils";
     ...
     * by function of {@link SlcApiUtils#registerImpl} when execute transform task.
     */
    ...
    public String toString() {
        return "SlcApiUtils: " + mInjectApiImplMap;
    }

    private static SlcApiUtils getInstance() {
    ...
    private static class LazyHolder {
        private static final SlcApiUtils INSTANCE = new SlcApiUtils();
    }
