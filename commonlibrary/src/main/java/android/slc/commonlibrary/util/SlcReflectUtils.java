 ...
 * </pre>
 */
public final class SlcReflectUtils {

    private final Class<?> type;

    private final Object object;

    private SlcReflectUtils(final Class<?> type) {
        this(type, type);
    }

    private SlcReflectUtils(final Class<?> type, Object object) {
        this.type = type;
        this.object = object;
    }
     ...
     * @return the single {@link SlcReflectUtils} instance
     * @throws ReflectException if reflect unsuccessfully
     */
    public static SlcReflectUtils reflect(final String className)
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static SlcReflectUtils reflect(final String className, final ClassLoader classLoader)
            throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static SlcReflectUtils reflect(final Class<?> clazz)
            throws ReflectException {
        return new SlcReflectUtils(clazz);
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public static SlcReflectUtils reflect(final Object object)
            throws ReflectException {
        return new SlcReflectUtils(object == null ? Object.class : object.getClass(), object);
    }
     ...
     * @return the single {@link SlcReflectUtils} instance
     */
    public SlcReflectUtils newInstance() {
     ...
     * @return the single {@link SlcReflectUtils} instance
     */
    public SlcReflectUtils newInstance(Object... args) {
    ...
    private SlcReflectUtils newInstance(final Constructor<?> constructor, final Object... args) {
        try {
            return new SlcReflectUtils(
     ...
     * @return the single {@link SlcReflectUtils} instance
     */
    public SlcReflectUtils field(final String name) {
        try {
            Field field = getField(name);
            return new SlcReflectUtils(field.getType(), field.get(object));
     ...
     * @return the single {@link SlcReflectUtils} instance
     */
    public SlcReflectUtils field(String name, Object value) {
        try {
            Field field = getField(name);
    ...
    private Object unwrap(Object object) {
        if (object instanceof SlcReflectUtils) {
            return ((SlcReflectUtils) object).get();
        }
        return object;
    }
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public SlcReflectUtils method(final String name) throws ReflectException {
     ...
     * @throws ReflectException if reflect unsuccessfully
     */
    public SlcReflectUtils method(final String name, final Object... args) throws ReflectException {
        Class<?>[] types = getArgsType(args);
        try {
    ...
    private SlcReflectUtils method(final Method method, final Object obj, final Object... args) {
        try {
            accessible(method);
    ...
    public boolean equals(Object obj) {
        return obj instanceof SlcReflectUtils && object.equals(((SlcReflectUtils) obj).get());
    }
